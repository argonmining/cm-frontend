    ...
    return (
        <button
            className={clsx(
                ...
                {
                    'bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white border-transparent hover:from-indigo-600 hover:via-purple-600 hover:to-pink-600 focus:ring-purple-500':
                        variant === 'primary',
